...
- [x] T042 [P] Implement GET /v1/jobs endpoint in src/aizk/conversion/api/routes/jobs.py: query jobs with filters (status, aizk_uuid, karakeep_id, created_after, created_before), pagination (limit, offset), return JobList
- [x] T043 Register routes in src/aizk/conversion/api/main.py: include jobs router with /v1 prefix
