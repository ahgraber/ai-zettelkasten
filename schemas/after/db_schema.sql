-- Post-migration schema for the conversion service (after c1d2e3f4a5b6).
-- Generated by running all Alembic migrations against a fresh SQLite database
-- and dumping CREATE TABLE / CREATE INDEX statements.
--
-- Dialect: SQLite (alembic batch-mode + explicit table-rebuild for FK changes)
-- Migration head: c1d2e3f4a5b6 (rename_bookmarks_to_sources)
